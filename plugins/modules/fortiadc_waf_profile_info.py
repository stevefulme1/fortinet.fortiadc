...
DOCUMENTATION = """
---
module: fortiadc_waf_profile_info
short_description: Get WAF profile info from Fortinet FortiADC.
description:
...
- name: Get all profiles
  fortinet.fortiadc.fortiadc_waf_profile_info:
    vdom: root
  register: result
    ...
    if module._socket_path:
        ...
        try:
            ...
            if module.params.get("name"):
                ...
                resp = fos.get("waf", "profile", vdom=vdom)
            module.exit_json(
                changed=False,
