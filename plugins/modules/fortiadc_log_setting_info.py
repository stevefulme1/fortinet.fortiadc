...
DOCUMENTATION = """
---
module: fortiadc_log_setting_info
short_description: Get log settings from Fortinet FortiADC.
description:
    - This module retrieves logging configuration from FortiADC.
version_added: "1.0.0"
author:
...
- name: Get log settings
  fortinet.fortiadc.fortiadc_log_setting_info:
    vdom: root
  register: result
"""
...
RETURN = """
log_setting:
  description: Log setting configuration.
  returned: always
  type: dict
"""
...
def main():
    ...
    if module._socket_path:
        ...
        try:
            ...
            resp = fos.get("log", "setting", vdom=vdom)
            module.exit_json(changed=False, log_setting=resp)
        except Exception as e:
            module.fail_json(msg="Failed to get log settings: %s" % str(e))
    else:
