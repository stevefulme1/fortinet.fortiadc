# Contributing to fortinet.fortiadc

Thank you for your interest in contributing to **fortinet.fortiadc**!
...
```bash
git clone https://github.com/stevefulme1/fortinet.fortiadc.git
cd fortinet.fortiadc
```
